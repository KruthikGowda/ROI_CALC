...
document.getElementById("Number_of_SKUs").addEventListener("blur", (e) => {
...
document.getElementById("Number_of_Warehouses_+_Cs_+_Stores").addEventListener("blur", (e) => {
  if (e.target.value === "" || e.target.value < 0) {
    alert("Please enter a valid number");
  } else {
...
document.getElementById("Annual_Revenue_(In USD millions)").addEventListener("blur", (e) => {
  if (e.target.value === "" || e.target.value < 0) {
    alert("Please enter a valid number");
  } else {
...
document.getElementById("Margin_%").addEventListener("blur", (e) => {
  if (e.target.value === "" || e.target.value < 0) {
    alert("Please enter a valid number");
  } else {
...
document.getElementById("Average_days_on_hand").addEventListener("blur", (e) => {
  if (e.target.value === "" || e.target.value < 0) {
    alert("Please enter a valid number");
  } else {
